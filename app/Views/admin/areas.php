            ...
            <div class="modal-body">
                <form id="form-area" autocomplete="off">
                    ...
                    <div class="form-group form-check">
                        ...
                        <label class="form-check-label" for="crearEnServicios">
                            También crear en Servicios
                        </label>
                        <small class="form-text text-muted d-block">
                            Si marca esta opción, se creará automáticamente un servicio con el mismo nombre y
                            descripción.
                        </small>
                    </div>
                </form>
