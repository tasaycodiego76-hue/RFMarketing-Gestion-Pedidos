...
function cronPausa(id) {
  Swal.fire({
    ...
    html: `
      <p style="font-size:13px; color:#aaa; margin-bottom:6px;">El motivo es <strong style="color:#f5c400;">obligatorio</strong>. Describe brevemente por qué pausas.</p>
      <textarea id="swal-motivo" class="swal2-textarea" placeholder="Ej: Reunión de equipo, almuerzo, esperando brief del cliente..." style="min-height:90px; font-size:13px; background:#222; color:#fff; border:1px solid #444; border-radius:8px; width:90%; padding:10px; box-sizing:border-box; resize:vertical;"></textarea>
